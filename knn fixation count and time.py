...
# En iyi sonucu izlemek için değişkenler
best_accuracy = 0
best_state = None
...
# Farklı random_state değerleri ile model eğitimi
for random_state in range(1, 201):  
    ...
    pipeline = make_pipeline(
        StandardScaler(),
        KNeighborsClassifier(n_neighbors=5)  # Burada komşu sayısını değiştirebilirsin
    )
